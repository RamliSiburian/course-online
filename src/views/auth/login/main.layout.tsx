                            ...
                            <Row gutter={[0, 15]}>
                                ...
                                <Col span={24}>
                                    <div className='flex justify-center items-center gap-8'>
                                        ...
                                        <div className='w-11 h-11 bg-[#FFF] rounded-full shadow-[2px_2px_5px_0px_rgba(0,0,0,0.1)] hover:shadow-blue-300 cursor-pointer flex justify-center items-center' onClick={() => console.log('sd')}>
